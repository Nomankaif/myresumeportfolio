  ...
  return (
    ...
    >
      <div className="main_left">
        ...
        <h2 className='names'>MD NOMAN KAIF</h2>
        ...
        <div className="flex1">
          ...
          <div className="logos">
            <a href="https://github.com/Nomankaif" target="_blank" rel="noreferrer">
              <img src={github} alt="GitHub" />
            </a>
            <a href="https://www.linkedin.com/in/md-noman-kaif/" target="_blank" rel="noreferrer">
              <img src={linked_in} alt="LinkedIn" />
            </a>
            <a href="https://leetcode.com/u/mdnomankaif55/" target="_blank" rel="noreferrer">
